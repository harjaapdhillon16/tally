            ...
            <div className="text-center space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground max-w-md mx-auto">
                  There are no transactions that need review at this time. New transactions will appear here automatically.
                </p>
              </div>
            </div>
          </CardContent>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                >
                  ...
                  <span className="hidden sm:inline">Approve {selectedTransactions.size} transaction{selectedTransactions.size === 1 ? '' : 's'}</span>
