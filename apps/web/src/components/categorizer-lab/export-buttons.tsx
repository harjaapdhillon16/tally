...
import type { LabTransaction, TransactionResult, Metrics, LabRunResponse } from '@/lib/categorizer-lab/types';
  ...
  const exportResultsAsCSV = () => {
    ...
    results.forEach(result => {
      ...
      const isCorrect = original?.categoryId && result.predictedCategoryId ? 
        (original.categoryId === result.predictedCategoryId ? 'true' : 'false') : '';
      ...
      <div className="space-y-4">
        ...
        <div className="text-sm text-gray-500">
          ...
          <ul className="list-disc list-inside mt-1 space-y-1">
            <li><strong>JSON:</strong> Complete results with metadata for programmatic use</li>
            <li><strong>CSV:</strong> Tabular format for analysis in Excel/Google Sheets</li>
            <li><strong>Metrics CSV:</strong> Summary statistics and per-category performance</li>
            <li><strong>Error Log:</strong> Text file with detailed error messages</li>
          </ul>
        </div>
