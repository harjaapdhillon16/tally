...
describe('Enhanced Input Validation', () => {
  describe('Basic validators', () => {
    ...
    test('should sanitize organization names', () => {
      const result = validators.organizationName.safeParse('  <script>alert("xss")</script>My Org  ');
  ...
  describe('Plaid schemas', () => {
    ...
    test('should validate webhook verification', () => {
      ...
      expect(validationSchemas.plaid.webhookVerification.safeParse(validWebhook).success).toBe(true);
      expect(validationSchemas.plaid.webhookVerification.safeParse(invalidWebhook).success).toBe(false);
    });
  });
  ...
  describe('withValidation middleware', () => {
    ...
    test('should validate and pass data to handler', async () => {
      const validatedHandler = withValidation(testSchema)(
        async (data, request) => {
